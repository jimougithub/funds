...
CREATE TABLE `fund_info` (
  ...
  `fund_ranking_ytd` decimal(7,4) NOT NULL,
  `fund_ranking_1w` decimal(7,4) NOT NULL,
  `fund_ranking_1m` decimal(7,4) NOT NULL,
  `fund_ranking_3m` decimal(7,4) NOT NULL,
  `fund_ranking_6m` decimal(7,4) NOT NULL,
  `fund_ranking_1y` decimal(7,4) NOT NULL,
  `fund_ranking_2y` decimal(7,4) NOT NULL,
  `fund_ranking_3y` decimal(7,4) NOT NULL,
  `fund_ranking_5y` decimal(7,4) NOT NULL,
